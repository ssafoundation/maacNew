...
export const getPackageData = (authtoken) =>
  get(`${url.PACKAGE_DATA}/getallpackages`, {
    headers: { Authorization: `Bearer ${authtoken}` },
  });
export const getSinglePackageData = (authtoken, packageID) =>
  get(`${url.PACKAGE_DATA}/getsinglepackage/${packageID}`, {
    headers: { Authorization: `Bearer ${authtoken}` },
  });
export const addPackageOrderData = (data, authtoken) =>
  post(`${url.ORDER_DATA}/createorder`, data, {
    headers: { Authorization: `Bearer ${authtoken}` },
  });

export const getUserPackageData = (authtoken, userID) =>
  get(`${url.USER_PACKAGE_DATA}/getallusercurrentPackage/${userID}`, {
    headers: { Authorization: `Bearer ${authtoken}` },
  });
export const getUserServiceData = (authtoken, packageID) =>
  get(`${url.USER_PACKAGE_DATA}/getallservices/${packageID}`, {
    headers: { Authorization: `Bearer ${authtoken}` },
  });
export const getQuestionData = (authtoken, serviceID) =>
  get(`${url.USER_PACKAGE_DATA}/getexampaper/${serviceID}`, {
    headers: { Authorization: `Bearer ${authtoken}` },
  });
export const addAnswerData = (data, authtoken) =>
  post(`${url.RESULT_DATA}/createresult`, data, {
    headers: { Authorization: `Bearer ${authtoken}` },
  });
export const getResultData = (authtoken, serviceID) =>
  get(`${url.USER_PACKAGE_DATA}/getexampaper/${serviceID}`, {
    headers: { Authorization: `Bearer ${authtoken}` },
  });
